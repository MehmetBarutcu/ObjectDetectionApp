...
def count_vehicles(bbox, identities, categories, area, v_count, offset=(0,0)):
        ...
        for i, det in enumerate(pred):  # detections per image
            ...
            if len(det):
                ...
                if len(tracked_dets)>0:
                    ...
                    v_count = count_vehicles(bbox_xyxy,identities,categories,area,v_count)
            ...
            color = (0,255,0)
            area2 = np.array([[552,605-100],[560,760-100],[1211,652-100],[1127,590-100]],np.int32)
